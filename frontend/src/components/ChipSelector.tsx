...
const chipSeries = {
  ...
  STM32: [
    ...
    { value: 'stm32f429igt6', label: 'STM32F429IG' },
    { value: 'stm32h743zi', label: 'STM32H743ZI' },
    { value: 'stm32g431kb', label: 'STM32G431KB' },
    { value: 'stm32l476rg', label: 'STM32L476RG' },
    { value: 'stm32wl55jc', label: 'STM32WL55JC' },
  ],
  ESP32: [
